...
if (!\function_exists('DevOwl\\RealCookieBanner\\Vendor\\json5_decode')) {
    /**
    ...
    {
        return \DevOwl\RealCookieBanner\Vendor\ColinODell\Json5\Json5Decoder::decode($source, $associative, $depth, $options);
    }
}
// PHP 7.3 polyfills
