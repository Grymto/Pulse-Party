...
class Tickcounter extends ProviderAdapter implements ProviderInterface
{
    ...
    public function getFakeResponse()
    {
        ...
        $attr[] = 'title=""';
        return ['type' => 'rich', 'provider_name' => 'Tickcounter', 'provider_url' => 'https://tickcounter.com', 'title' => 'Unknown title', 'html' => '<div style="left:0; width:500px; height:125px; position:relative; padding-bottom:0; margin:0 auto"><iframe ' . \implode(' ', $attr) . '></iframe></div>'];
    }
}
